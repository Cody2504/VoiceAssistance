...
class ViCLIP(nn.Module):
    ...
    def __init__(self,  
        ...
        if pretrain:
            ...
            # Local change vs upstream: the official checkpoint pickles an
            # EasyDict in its metadata, which torch>=2.6 weights_only=True
            # rejects. The file is user-downloaded from OpenGVLab/ViCLIP.
